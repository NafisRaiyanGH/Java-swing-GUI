...
public AboutProject()
{
  ...
  this.initializeComponents();
    ...
    this.setTitle("About :Student Management System");
...
public void initializeComponents(){
    ...
    this.headline=new JLabel("About Student Management System");
    ...
    this.panel.add(this.labeldasbord);
     ...
     this.textAbout = new JTextArea(" A university (also called \"knowledge\" in American English or \"community\n"
          );

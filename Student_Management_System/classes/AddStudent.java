...
public class AddStudent extends JFrame implements ActionListener {
    ...
    private String[] columns = {"ID","Student Name","Course Cost","School","Grade"};
    ...
    public void initComponents(){
       ...
       this.setVisible(true);
        ...
        mnLabel = new JLabel("Student Name    ");
        ...
        cuLabel = new JLabel("Cost Per Course    ");
        ...
        saveButton = new JButton("Save Student Info");

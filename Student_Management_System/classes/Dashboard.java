...
public class Dashboard extends JFrame{
 ...
 private Font f,ff,fff;  
   ...
   public  Dashboard()
   {
    ...
    this.setTitle(" Dashboard :  Student Management System");
   ...
   { 
       ...
       this.buttonam = new JButton("Add Student");
...
buttonabout.setFont(ff);
   ...
   buttonexit .setFont(ff);
    ...
    this.panel.add(this.labeldasbord);
     ...
     this.headline=new JLabel("Student Management System");
